...
<div class="dashboard-nav">
    ...
    <nav class="dashboard-nav-list">
        ...
        <a href="produits.php" class="dashboard-nav-item active"><i class="fa-solid fa-boxes-stacked"></i>Catalogue des produits</a>
        <a href="./../listeStatutsCommandes.php" class="dashboard-nav-item active"><i class="fa-solid fa-cart-shopping"></i>Commandes</a>
