...
//Récupération de l'élément du bouton de fermeture de chatbot
const closeButton = document.querySelector('.chat-box-toggle');

//Ajout d'un écouteur d'évènements de clic sur le bouton
closeButton.addEventListener('click', () =>{
    //Rénitialisation de la conversation 
    resetConversation();
}); 

function resetConversation() {
    // Code pour réinitialiser la conversation
